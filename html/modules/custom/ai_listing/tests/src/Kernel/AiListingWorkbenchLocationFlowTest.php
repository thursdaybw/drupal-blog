...
final class AiListingWorkbenchLocationFlowTest extends KernelTestBase {
  ...
  /**
   * Checks that a plain term label resolves during location confirm submit.
   */
  public function testLocationConfirmAcceptsExactStorageLocationLabel(): void {
    $this->getWorkbenchTempstore()->set(AiListingWorkbenchForm::LOCATION_CONFIRM_TEMPSTORE_KEY, [
      'selection' => [
        ['listing_type' => 'book', 'id' => 12],
      ],
    ...
    $formState->setValue('location_term', 'BDMAA02');
