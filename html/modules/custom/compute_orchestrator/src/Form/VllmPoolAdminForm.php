  ...
  public function buildForm(array $form, FormStateInterface $form_state): array {
    ...
    $form['how_it_works']['help'] = [
      ...
      '#markup' => implode('', [
        ...
        '<ol>',
        '<li><strong>Acquire</strong> first tries to reuse an <strong>available</strong> instance of the requested server profile. Availability is lease state; a stopped instance can still be available and may be restarted on acquire. Fresh provisioning only happens when no reusable available capacity exists.</li>',
        ...
        '<li><strong>Reap available</strong> only applies to instances in <strong>available</strong> status. It stops them after the post-lease grace period has passed, but keeps them available for future acquire/restart.</li>',
